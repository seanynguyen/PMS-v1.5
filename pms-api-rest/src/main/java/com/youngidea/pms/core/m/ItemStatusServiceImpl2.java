 ...
 */
package com.youngidea.pms.core.m;

import com.youngidea.pms.core.api.rest.m.Person;
...
public class ItemStatusServiceImpl2 {
    ...
    private static final ConcurrentMap<String, com.youngidea.pms.core.api.rest.m.Person> persons = new ConcurrentHashMap<String, com.youngidea.pms.core.api.rest.m.Person>();

    @GET
    public Collection<com.youngidea.pms.core.api.rest.m.Person> getAll() {
    ...
    @GET
    @Path("{id}")
    public com.youngidea.pms.core.api.rest.m.Person getPerson(
            @PathParam("id")
...
//            String name) {
    public Response createPerson(@com.youngidea.pms.core.api.rest.m.ValidPerson Person person) {
